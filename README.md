<!-- Stylish LeetCode Problem Solutions with Python -->

<p align="center">
  <img src="https://leetcode.com/static/images/LeetCode_logo.png" alt="LeetCode Logo"/>
</p>

<h1 align="center">LeetCode-75 Problem Solutions in Python</h1>
...
📄 [Solution](dp_multidimensional/best_time_to_buy_stock.py)

### Edit Distance (Medium)
🔗 [Problem](https://leetcode.com/problems/edit-distance/)
📄 [Solution](dp_multidimensional/edit_distance.py)

## Bit Manipulation

### Counting Bits (Easy)
🔗 [Problem](https://leetcode.com/problems/counting-bits/)
📄 [Solution](bit_manipulation/counting_bits.py)

### Single Number (Easy)
🔗 [Problem](https://leetcode.com/problems/single-number/)
📄 [Solution](bit_manipulation/single_number.py)
...
📄 [Solution](bit_manipulation/min_flips_to_equal.py)

## Trie

### Implement Trie (Prefix Tree) (Medium)
🔗 [Problem](https://leetcode.com/problems/implement-trie-prefix-tree/)
📄 [Solution](trie/implement_trie.py)

### Search Suggestions System (Medium)
🔗 [Problem](https://leetcode.com/problems/search-suggestions-system/)
📄 [Solution](trie/search_suggestions.py)

## Intervals

### Non-overlapping Intervals (Medium)
🔗 [Problem](https://leetcode.com/problems/non-overlapping-intervals/)
📄 [Solution](intervals/non_overlapping_intervals.py)

### Minimum Number of Arrows to Burst Balloons (Medium)
🔗 [Problem](https://leetcode.com/problems/minimum-number-of-arrows-to-burst-balloons/)
📄 [Solution](intervals/min_arrows_to_burst.py)

## Monotonic Stack

### Daily Temperatures (Medium)
🔗 [Problem](https://leetcode.com/problems/daily-temperatures/)
📄 [Solution](monotonic_stack/daily_temperatures.py)

### Online Stock Span (Medium)
🔗 [Problem](https://leetcode.com/problems/online-stock-span/)
📄 [Solution](monotonic_stack/online_stock_span.py)

<p align="center">
  Embark on this journey of elegance and intellect. Happy coding! 🎉🐍
</p>
